...
class Log_console extends Log
{
                         ...
                         $level = PEAR_LOG_DEBUG)
    {
        ...
        /*
         * If output buffering has been requested, we need to register a shutdown function that will dump the buffer upon termination.
         */
        if ($this->_buffering) {
    ...
    {
        /*
         * If output buffering is enabled, dump the contents of the buffer to the output stream.
         */
